...
export default function TweetPage(props) {
  ...
  useEffect(() => {
    ...
    const fetchTweet = (tweetId) => {
      axios
        .get(`https://engagebackend-git-deployment-adityaprajapatis-projects.vercel.app/tweet/gettweet/${tweetId}`, {
    ...
    const fetchComments = () => {
      axios
        .get(
          `https://engagebackend-git-deployment-adityaprajapatis-projects.vercel.app/tweet/getcomments/${tweetId}`, // comment is treated as tweet
          { withCredentials: true }
        )
        .then((res) => {
