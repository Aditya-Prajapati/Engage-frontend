...
export default function Signup(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(
        "https://engagebackend-git-deployment-adityaprajapatis-projects.vercel.app/auth/signup",
  ...
  return (
    ...
    >
      <div className="card align-items-center" id="Login" style={{ background: (DarkMode && "#282828") }}>
        ...
        <LoginButton
          isGoogleLogin={true}
          link="https://engagebackend-git-deployment-adityaprajapatis-projects.vercel.app/auth/google"
          icon={
            <svg
        ...
        >
          ...
          <p style={{ color: "red", margin: "4px 0", height: "10px" }}>
            {" "}
            {signUpMsg}{" "}
          </p>
        ...
        <div className="NotAccount d-flex" style={{ marginTop: "1rem" }}>
